...
remove_shortcode('counter-element');

function sc_budi_counter_element($atts, $content = null){
    $atts = shortcode_atts([
         'border_radius' => '0px',
         'bg_color' => '#f2f2f2',
         'image' => '',
    ...
    budi_add_style('counter-element', this_dir_url(__FILE__) . "counter.css");
    budi_add_script('counter-element2-js', this_dir_url(__FILE__) . "jQuery.countTo.js");
    ...
    <div id="<?php echo $element_id; ?>" class="counter-element <?php echo $css_class; ?>">
        ...
        <p class="counter-element-timer" data-from="0" data-to="<?php echo $atts['value']; ?>" data-speed="<?php echo $atts["speed"]; ?>" data-refresh-interval="50" data-decimals="<?php echo strpos($atts['value'], '.') !== false ? strlen(substr(strrchr($atts['value'], '.'), 1)) : 0; ?>">0</p>
...
add_shortcode('counter-element', 'sc_budi_counter_element');
