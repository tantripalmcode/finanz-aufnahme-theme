        ...
        <div id="<?php echo esc_attr($widget_id); ?>" class="budi-benefit-tabs__wrapper <?php echo esc_attr($widget_class); ?>">
            ...
            <div class="budi-benefit-tabs__container">
                ...
                <div class="budi-benefit-tabs__floating-icon-container">
                    ...
                    ?>
                        <div class="budi-benefit-tabs__floating-icon budi-benefit-tabs__floating-icon--<?php echo esc_attr($icon_position); ?>" style="--icon-width: <?php echo esc_attr($floating_icon_width); ?>;">
                ...
                <div class="budi-benefit-tabs__content">
                    <?php foreach ($sc_benefit_tabs as $index => $item) {
                        ...
                        $content_col_class      = $image_position === 'left' ? 'col-lg-6 order-lg-2' : 'col-lg-6 order-lg-1';
                        $image_col_class        = $image_position === 'left' ? 'col-lg-6 order-lg-1' : 'col-lg-6 order-lg-2';
                    ?>
                            ...
                            <div class="row ">
                                ...
                                <div class="<?php echo $content_col_class; ?>">
                                    <div class="budi-benefit-tabs__content-text h-100 d-flex flex-column position-relative">
                                        ...
                                        <h2 class="budi-benefit-tabs__title">
                                        ...
                                        <?php if ($button_url) : ?>
                                            <div class="budi-benefit-tabs__button-wrapper">
                                ...
                                <div class="<?php echo $image_col_class; ?>">
                                    <div class="budi-benefit-tabs__image-wrapper">
                                        <?php if ($image) : ?>
                                            <?php echo wp_get_attachment_image($image, 'large', false, ['class' => 'budi-benefit-tabs__image img-fluid']); ?>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
