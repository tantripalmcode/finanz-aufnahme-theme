...
<div class="budi-icon-box-grid__item">
    <div class="budi-icon-box-grid__item-header d-flex <?php echo !$for_mobile ? 'flex-column flex-lg-row' : ''; ?> align-items-start">
        <?php if ( $image ) {
            echo wp_get_attachment_image( $image, $image_size, false, ['class' => 'budi-icon-box-grid__item-image ' . $image_class] );
        } ?>

        <div class="budi-icon-box-grid__item-content-wrapper">
